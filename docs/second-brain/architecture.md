...
*Last updated: 2026-08-25 — verified against commit `378568fd` (working tree ahead: cherry-picked
from `feat/backend`); `BaseAgent` now takes a generic `pydantic_ai.providers.Provider[AsyncOpenAI]`
