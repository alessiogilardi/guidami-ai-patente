...
(removed by commit `0a18903`) replaced with a pointer to `docs/second-brain/architecture.md`
and `docs/superpowers/specs/2026-08-05-quiz-per-element-layers-design.md`.*
...
`VariantSpec[T]`) was rejected, see `docs/second-brain/adr/0014-embedding-composition-layer.md`.
...
(`compose_or_none(model) -> str | None`) — see `docs/second-brain/patterns.md`. **embedded_text** entry
